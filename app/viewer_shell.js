...
export function mountViewerShell(documentRef, target = documentRef.body) {
  ...
  masthead.append(
    ...
    createElement(documentRef, 'h1', 'mhr-shell__title', 'Contract-first runtime shell'),
    createElement(
      documentRef,
      'p',
      'mhr-shell__subtitle',
      'This shell proves ownership, protocol, and asset boundaries before runtime-heavy implementation.',
    ),
  );
