...
- **Multi-LoD support**: the local/runtime surface supports `lod0..lod6`; the current public browser deployments ship embeddable `lod1..lod6` viewers.
...
- The GitHub Pages mirror intentionally excludes `lod0`; `lod1..lod6` are published there, while the heavier `lod0` bundle is reserved for larger-site hosting.
...
- `public_assets/`: tracked viewer assets used by the public deployment builds
